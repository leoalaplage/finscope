...
describe("the government yields a market page carries", () => {
  ...
  it("leaves out France and Italy rather than filling them with a stale figure", () => {
    /*
     * Not an oversight, and the reason is written into the registry: France's
     * daily ten-year is Euronext's TEC 10 and Italy's comes from MTS, both
     * under licences that forbid redistribution. The ECB's monthly average is
     * free to reuse, but a monthly average in a row of daily readings reads as
     * a broken feed.
     */
