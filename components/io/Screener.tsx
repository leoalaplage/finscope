    ...
    <main className="wrap" id="main-content" tabIndex={-1}>
      ...
      <section className="section" style={{ borderTop: 0 }}>
        <div className="section-head">
          {/*
            * One control: the weighting the score is struck under.
            *
            * Not a filter. A minimum score, a maximum alert count and a sector
            * box were added here and each of them hides companies — on a list
            * of twenty-seven the reader chose themselves, where the whole point
            * is to see every one of them ranked against the same scale. What
            * they hid was the bottom of the list, which is where a screener
            * earns its keep.
            */}
          <div className="seg">
