...
export const DEFAULT_WATCHLIST: CompanyProfile[] = [
  ...
  us({ name: "CME Group Inc.", ticker: "CME", yahooTicker: "CME", cik: "0001156375", exchange: "NASDAQ", sector: "Exchanges", description: "Derivatives exchanges and clearing services.", businessType: "financial", stockSplits: [{ date: "2012-07-20", ratio: 5 }] }),
