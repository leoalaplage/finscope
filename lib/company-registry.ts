...
export const DEFAULT_WATCHLIST: CompanyProfile[] = [
  ...
  us({ name: "CME Group Inc.", ticker: "CME", yahooTicker: "CME", cik: "0001156375", exchange: "NASDAQ", sector: "Exchanges", description: "Derivatives exchanges and clearing services.", businessType: "exchange", stockSplits: [{ date: "2012-07-20", ratio: 5 }] }),
  ...
  us({ name: "Interactive Brokers Group, Inc.", ticker: "IBKR", yahooTicker: "IBKR", cik: "0001381197", exchange: "NASDAQ", sector: "Brokerage", description: "Electronic brokerage and market making.", businessType: "broker", stockSplits: [{ date: "2025-06-17", ratio: 4 }] }),
  ...
  us({ name: "Cboe Global Markets, Inc.", ticker: "CBOE", yahooTicker: "CBOE", cik: "0001374310", exchange: "Cboe BZX", sector: "Exchanges", description: "Options, equities and derivatives market infrastructure.", businessType: "exchange" }),
