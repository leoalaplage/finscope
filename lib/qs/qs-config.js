...
/*
 * Combien du modele une societe doit porter pour meriter une lettre.
 *
 * Abaisse de 0,75 a 0,70. Le seuil existe pour empecher qu'une note repose sur
 * un tiers du modele, pas pour refuser une societe complete a laquelle il
 * manque une mesure ou deux. A 75 %, une seule metrique ajoutee au modele
 * pouvait faire tomber un dossier par ailleurs entier : Booking, avec ses
 * quatre piliers renseignes, est passe sous la barre le jour ou le R2 du
 * FCF/action a ete ajoute au pilier Quality — la societe n'avait pas change,
 * le denominateur si.
 *
 * Ce que 70 % laisse encore dehors est le vrai objet du seuil : une banque ou
 * un courtier, pour qui la moitie des mesures n'a pas de sens et dont la
 * couverture se compte en dizaines de points, pas en unites. Ceux-la restent
 * NR, et la page dit desormais pourquoi plutot que de se taire.
 *
 * Sur les vingt-huit societes du site le jour du changement, aucune ne se
 * trouve entre 70 et 75 % : la baisse ne rattrape personne aujourd'hui. Elle
